...
<head>
  ...
  <title>氣質診断管理システム | メンバー情報</title><!-- 20171002 -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="member_list.php"><i class="fa fa-circle-o"></i>メンバー情報一覧</a></li>
            ...
            <div class="box-body">
              <table class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th class="huntsys1">区分</th>
                  <th class="huntsys1">担当</th>
                  <th class="huntsys1">住所</th>
                  <th class="huntsys1">電話番号１</th>
                  <th class="huntsys1">電話番号２</th>
                  <th class="huntsys1">名刺</th>
                  <th class="huntsys1">メルマガ</th>
                  <th class="huntsys1">気質診断</th>
                  <th class="huntsys1">参加イベント</th>
			  ...
			  <?php
				...
				$sql101 = '';
				$result101 = '';
				$where101 .= "member_id > '" . '0' . "' and ";
				$where101 .= '1 = 1';
				$sql101 = "select * from member where $where101 order by member_id";
				$result101 = mysqli_query( $link1, $sql101 ) or die('query error201' . mysql_error());
		        
			  ?>
			  <?php $m = 0; while ( $member = mysqli_fetch_array( $result101 ) ) { ?>
				  <?php
					$where103 = '';
					$sql103 = '';
					$result103 = '';
					$sql103 = "select * from member where member_id = '" . $member['mbr_person'] . "'";
				  ...
				  <?php
					...
					$sql105 = '';
					$result105 = '';
					$sql105 = "select * from kievent where kievent_id = '" . $member['mbr_kieventid'] . "'";
					$result105 = mysqli_query( $link1, $sql105 );
					$kievent = mysqli_fetch_array( $result105 );
				  ?>
				<tr>
				  <td class="huntsys1"><?php echo $member['mbr_kanji'] ?></td>
				  <td class="huntsys1"><?php echo $member['mbr_mailadd'] ?></td>
				  <td class="huntsys1"><?php echo $member['mbr_birthday'] ?></td>
				  <td class="huntsys1"><?php echo $mbrtype_tbl[$member['mbr_type']] ?></td>
				  <td class="huntsys1"><?php echo $member103['mbr_kanji'] ?></td>
				  <td class="huntsys1"><?php echo $member['mbr_add'] ?></td>
				  <td class="huntsys1"><?php echo $member['mbr_phone1'] ?></td>
				  <td class="huntsys1"><?php echo $member['mbr_phone2'] ?></td>
				  <td class="huntsys1"><?php echo $umu_tbl[$member['mbr_namecd']] ?></td>
				  <td class="huntsys1"><?php echo $umu_tbl[$member['mbr_mailmg']] ?></td>
				  <td class="huntsys1"><?php echo $umu_tbl[$member['mbr_kishitsu']] ?></td>
