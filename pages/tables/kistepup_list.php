...
<head>
  ...
  <title>氣質診断管理システム | 昇段受講情報</title><!-- 20171002 -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="kistepup_list.php"><i class="fa fa-circle-o"></i>昇段受講情報一覧</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            ...
            <div class="box-body">
              <table class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th class="huntsys1">種類</th>
                  <th class="huntsys1">入金日</th>
                  <th class="huntsys1">受講日</th>
                  <th class="huntsys1">昇段数</th>
                  <th class="huntsys1">申請日</th>
                  <th class="huntsys1">昇段日</th>
			  ...
			  <?php
				...
				$sql101 = '';
				$result101 = '';
				$where101 .= "ksu_memberid >= '" . '0' . "' and ";
				$where101 .= '1 = 1';
				$sql101 = "select * from kistepup where $where101 order by ksu_memberid, kistepup_id";
				$result101 = mysqli_query( $link1, $sql101 ) or die('query error288' . mysqli_error($link1));

			  ?>
			  <?php $m = 0; while ( $kistepup = mysqli_fetch_array( $result101 ) ) { ?>
				  <?php
					$where103 = '';
					$sql103 = '';
					$result103 = '';
					$sql103 = "select * from member where member_id = '" . $kistepup['ksu_person'] . "'";
				  ...
				  <?php
					...
					$sql105 = '';
					$result105 = '';
					$sql105 = "select * from member where member_id = '" . $kistepup['ksu_memberid'] . "'";
					$result105 = mysqli_query( $link1, $sql105 );
					$member = mysqli_fetch_array( $result105 );
				  ?>
				<tr>
				  <td class="huntsys1"><?php echo $member['mbr_kanji'] ?></td>
				  <td class="huntsys1"><?php echo $kistepup['ksu_applydate'] ?></td>
				  <td class="huntsys1"><?php echo $ksukinds_tbl[$kistepup['ksu_kinds']] ?></td>
				  <td class="huntsys1"><?php echo $kistepup['ksu_paydate'] ?></td>
				  <td class="huntsys1"><?php echo $kistepup['ksu_takedate'] ?></td>
				  <td class="huntsys1"><?php echo $kistepup['ksu_stepupnum'] ?></td>
				  <td class="huntsys1"><?php echo $kistepup['ksu_stepappdt'] ?></td>
				  <td class="huntsys1"><?php echo $kistepup['ksu_stepupdate'] ?></td>
