...
<head>
  ...
  <title>氣質診断管理システム | 受講歴情報</title><!-- 20171002 -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="kicourse_list.php"><i class="fa fa-circle-o"></i>受講歴情報一覧</a></li>
            ...
            <div class="box-body">
              <table class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th class="huntsys1">受講級</th>
                  <th class="huntsys1">申込日</th>
                  <th class="huntsys1">受講タイプ</th>
                  <th class="huntsys1">入金日</th>
                  <th class="huntsys1">テスト送信日</th>
                  <th class="huntsys1">受験日</th>
                  <th class="huntsys1">合格日</th>
                  <th class="huntsys1">担当</th>
                  <th class="huntsys1">認定カード</th>
                  <th class="huntsys1">送付</th>
                  <th class="huntsys1">月会費手続き</th>
			  ...
			  <?php $m = 0; while ( $kicourse = mysqli_fetch_array( $result101 ) ) { ?>
				  <?php
					...
					$sql103 = '';
					$result103 = '';
					$sql103 = "select * from member where member_id = '" . $kicourse['kcs_person'] . "'";
					$result103 = mysqli_query( $link1, $sql103 );
					$member103 = mysqli_fetch_array( $result103 );
				  ?>
				  <?php
					$where105 = '';
					$sql105 = '';
					$result105 = '';
					$sql105 = "select * from member where member_id = '" . $kicourse['kcs_memberid'] . "'";
					$result105 = mysqli_query( $link1, $sql105 );
					$member = mysqli_fetch_array( $result105 );
				  ?>
				<tr>
				  <td class="huntsys1"><?php echo $member['mbr_kanji'] ?></td>
				  <td class="huntsys1"><?php echo $stepclass_tbl[$kicourse['kcs_stepclass']] ?></td>
				  <td class="huntsys1"><?php echo $kicourse['kcs_applydate'] ?></td>
				  <td class="huntsys1"><?php echo $kcstype_tbl[$kicourse['kcs_type']] ?></td>
				  <td class="huntsys1"><?php echo $kicourse['kcs_paydate'] ?></td>
				  <td class="huntsys1"><?php echo $kicourse['kcs_testdate'] ?></td>
				  <td class="huntsys1"><?php echo $kicourse['kcs_examdate'] ?></td>
				  <td class="huntsys1"><?php echo $kicourse['kcs_passdate'] ?></td>
				  <td class="huntsys1"><?php echo $member103['mbr_kanji'] ?></td>
				  <td class="huntsys1"><?php echo $prostate_tbl[$kicourse['kcs_certcd']] ?></td>
				  <td class="huntsys1"><?php echo $prostate_tbl[$kicourse['kcs_send']] ?></td>
				  <td class="huntsys1"><?php echo $prostate_tbl[$kicourse['kcs_monthfee']] ?></td>
